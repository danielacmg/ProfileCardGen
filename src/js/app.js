 ...
 * 
    {
        includeCover: false, // if includeCover is true the algorithm should
...
function messageAlert(variables) {
  //let isEmpty = false;

  for (let items in variables) {
    if (!variables[items] || variables[items] == "") {
      //isEmpty = true;
